  ...
  return (
    <div className="bg-gray-50 font-inter rounded-md shadow-md overflow-hidden">
      ...
      <div className="mt-8 flex justify-center items-center flex-col px-5 pb-5">
        ...
        <Link className="mt-8 py-2 px-7  border-b-primary_color border-b-2 rounded-md uppercase duration-200 text-primary_color text-xl font-medium hover:bg-text_color_primary hover:border-b-text_color_primary hover:text-white">
          Add to Cart
        </Link>
      </div>
    </div>
